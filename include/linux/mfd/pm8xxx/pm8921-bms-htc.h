...
#if defined(CONFIG_MACH_M7_UL) || defined(CONFIG_MACH_M4_UL) || defined(CONFIG_MACH_T6_UL) || defined(CONFIG_MACH_T6_DWG) || defined(CONFIG_MACH_ZARA) || defined(CONFIG_MACH_DLXP)
