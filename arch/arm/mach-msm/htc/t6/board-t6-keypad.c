/* arch/arm/mach-msm/board-t6-keypad.c
...
static struct gpio_event_input_info t6_keypad_power_info = {
...
# endif
	.keymap = t6_keypad_map,
	.keymap_size = ARRAY_SIZE(t6_keypad_map),
};

static struct gpio_event_info *t6_keypad_info[] = {
	&t6_keypad_power_info.info,
};
...
static struct platform_device t6_reset_keys_device = {
	.name = KEYRESET_NAME,
	.dev.platform_data = &t6_reset_keys_pdata,
};

int __init t6_init_keypad(void)
{
	if (platform_device_register(&t6_reset_keys_device))
