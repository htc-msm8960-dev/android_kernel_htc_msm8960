...
static int t6china_get_hw_component(void)
{
...
static int t6china_enable_digital_mic(void)
{
	int ret;
...
static struct acoustic_ops acoustic = {
	.enable_digital_mic = t6china_enable_digital_mic,
	.get_hw_component = t6china_get_hw_component,
	.set_q6_effect = apq8064_set_q6_effect_mode
};

static int t6china_aud_speaker_vdd_enable(char *power_vreg_name, unsigned volt)
{
...
static int t6china_aud_vdd_enable(char *power_vreg_name, unsigned volt)
{
...
static void htc_audio_init(void)
{
	...
	t6china_aud_vdd_enable("aud_vdd_L9", 3000000);
	t6china_aud_speaker_vdd_enable("tfa9887_vdd_LVS2", 1800000);
}
