...
struct regulator_init_data t6china_saw_regulator_pdata_8921_s5 =
	/*	      ID  vreg_name	       min_uV   max_uV */
	SAW_VREG_INIT(S5, "8921_s5",	       850000, 1300000);
struct regulator_init_data t6china_saw_regulator_pdata_8921_s6 =
	SAW_VREG_INIT(S6, "8921_s6",	       850000, 1300000);

struct regulator_init_data t6china_saw_regulator_pdata_8821_s0 =
	/*	      ID       vreg_name	min_uV  max_uV */
	SAW_VREG_INIT(8821_S0, "8821_s0",       850000, 1300000);
struct regulator_init_data t6china_saw_regulator_pdata_8821_s1 =
...
struct rpm_regulator_platform_data t6china_rpm_regulator_pdata __devinitdata = {
	.init_data		= t6china_rpm_regulator_init_data,
	.num_regulators		= ARRAY_SIZE(t6china_rpm_regulator_init_data),
