...
void __init t6dwg_pm8xxx_gpio_mpp_init(void)
{
	int i, rc;
...
static struct pm8xxx_pwrkey_platform_data t6dwg_pm8921_pwrkey_pdata = {
	.pull_up		= 1,
	.kpd_trigger_delay_us	= 15625,
	.wakeup			= 1,
};

static struct pm8xxx_misc_platform_data t6dwg_pm8921_misc_pdata = {
	.priority		= 0,
};
...
static struct pm8xxx_led_platform_data t6dwg_pm8921_leds_pdata = {
	.num_leds = ARRAY_SIZE(pm8921_led_info),
	.leds = pm8921_led_info,
};


static struct pm8xxx_adc_amux t6dwg_pm8921_adc_channels_data[] = {
...
static struct pm8xxx_adc_properties t6dwg_pm8921_adc_data = {
	.adc_vdd_reference	= 1800, 
	.bitresolution		= 15,
	.bipolar                = 0,
};
static const struct pm8xxx_adc_map_pt t6dwg_adcmap_btm_table[] = {
	{-200,	1671},
	{-190,	1663},
	{-180,	1654},
	{-170,	1646},
...
static struct pm8xxx_adc_map_table pm8xxx_adcmap_btm_table = {
	.table = t6dwg_adcmap_btm_table,
	.size = ARRAY_SIZE(t6dwg_adcmap_btm_table),
};

static struct pm8xxx_adc_platform_data t6dwg_pm8921_adc_pdata = {
	.adc_channel		= t6dwg_pm8921_adc_channels_data,
	.adc_num_board_channel	= ARRAY_SIZE(t6dwg_pm8921_adc_channels_data),
	.adc_prop		= &t6dwg_pm8921_adc_data,
	.adc_mpp_base		= PM8921_MPP_PM_TO_SYS(1),
	.adc_map_btm_table	= &pm8xxx_adcmap_btm_table,
	.pm8xxx_adc_device_register	= t6dwg_pm8xxx_adc_device_register,
};

static struct pm8xxx_mpp_platform_data
t6dwg_pm8921_mpp_pdata __devinitdata = {
	.mpp_base	= PM8921_MPP_PM_TO_SYS(1),
};

static struct pm8xxx_gpio_platform_data
t6dwg_pm8921_gpio_pdata __devinitdata = {
	.gpio_base	= PM8921_GPIO_PM_TO_SYS(1),
};

static struct pm8xxx_irq_platform_data
t6dwg_pm8921_irq_pdata __devinitdata = {
...
static int t6dwg_pm8921_therm_mitigation[] = {
	1100,
	700,
	600,
	225,
...
pm8921_chg_pdata __devinitdata = {
	...
	.pj_in_irq	  = PM8921_GPIO_IRQ(PM8921_IRQ_BASE, POGO_ID),
	.pj_in_gpio   = PM8921_GPIO_PM_TO_SYS(POGO_ID),
	.pj_vol_mpp   = PM8XXX_AMUX_MPP_12,
	.pj_vol_mpp_sys = PM8921_MPP_PM_TO_SYS(PM8XXX_AMUX_MPP_12),
	.pj_adc_amux  = ADC_MPP_1_AMUX6,
#ifdef CONFIG_IOEXTENDER
	.pj_to_batt_gpio_ext	= IOEXT_GPIO_4,
	.batt_to_pj_gpio_ext	= IOEXT_GPIO_5,
#endif
	.pj_full_vol		= 4250,
	.is_aicl_enabled	= 1,
	.is_embeded_batt	= 1,
	...
	.thermal_mitigation	= t6dwg_pm8921_therm_mitigation,
	.thermal_levels		= ARRAY_SIZE(t6dwg_pm8921_therm_mitigation),
...
t6dwg_pm8921_platform_data __devinitdata = {
	.regulator_pdatas	= t6china_pm8921_regulator_pdata,
	.irq_pdata		= &t6dwg_pm8921_irq_pdata,
	.gpio_pdata		= &t6dwg_pm8921_gpio_pdata,
	.mpp_pdata		= &t6dwg_pm8921_mpp_pdata,
	.rtc_pdata		= &t6dwg_pm8921_rtc_pdata,
	.pwrkey_pdata	= &t6dwg_pm8921_pwrkey_pdata,
	.misc_pdata		= &t6dwg_pm8921_misc_pdata,
	.leds_pdata		= &t6dwg_pm8921_leds_pdata,
	.adc_pdata		= &t6dwg_pm8921_adc_pdata,
	.charger_pdata		= &pm8921_chg_pdata,
	.bms_pdata		= &pm8921_bms_pdata,
	.ccadc_pdata		= &t6dwg_pm8xxx_ccadc_pdata,
	.vibrator_pdata         = &pm8xxx_vib_pdata,
};

static struct pm8xxx_irq_platform_data
t6dwg_pm8821_irq_pdata __devinitdata = {
...
static struct pm8xxx_mpp_platform_data
t6dwg_pm8821_mpp_pdata __devinitdata = {
	.mpp_base	= PM8821_MPP_PM_TO_SYS(1),
};

static struct pm8821_platform_data
t6dwg_pm8821_platform_data __devinitdata = {
	.irq_pdata	= &t6dwg_pm8821_irq_pdata,
	.mpp_pdata	= &t6dwg_pm8821_mpp_pdata,
};

static struct msm_ssbi_platform_data t6dwg_ssbi_pm8921_pdata __devinitdata = {
	.controller_type = MSM_SBI_CTRL_PMIC_ARBITER,
	.slave	= {
		.name		= "pm8921-core",
		.platform_data	= &t6dwg_pm8921_platform_data,
	},
};

static struct msm_ssbi_platform_data t6dwg_ssbi_pm8821_pdata __devinitdata = {
	.controller_type = MSM_SBI_CTRL_PMIC_ARBITER,
	.slave	= {
		.name		= "pm8821-core",
		.platform_data	= &t6dwg_pm8821_platform_data,
	},
};

void __init t6dwg_init_pmic(void)
{
	pmic_reset_irq = PM8921_IRQ_BASE + PM8921_RESOUT_IRQ;
	apq8064_device_ssbi_pmic1.dev.platform_data =
						&t6dwg_ssbi_pm8921_pdata;
	apq8064_device_ssbi_pmic2.dev.platform_data =
				&t6dwg_ssbi_pm8821_pdata;
	t6dwg_pm8921_platform_data.num_regulators =
					t6china_pm8921_regulator_pdata_len;

}
void __init t6dwg_init_pmic_register_cam_cb(void *cam_vcm_on_cb, void *cam_vcm_off_cb)
{
	/*if (cam_vcm_on_cb)
