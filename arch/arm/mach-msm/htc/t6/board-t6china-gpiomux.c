...
void __init t6china_init_gpiomux(void)
{
	...
	msm_gpiomux_install(t6china_gsbi_configs, ARRAY_SIZE(t6china_gsbi_configs));

	msm_gpiomux_install(t6china_slimbus_config, ARRAY_SIZE(t6china_slimbus_config));
...
#ifdef CONFIG_USB_EHCI_MSM_HSIC
	msm_gpiomux_install(t6china_hsic_configs, ARRAY_SIZE(t6china_hsic_configs));
#endif
